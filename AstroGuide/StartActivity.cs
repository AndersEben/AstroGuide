...
namespace AstroGuide
{
    ...
    class StartActivity : AppCompatActivity
    {
        ...
        private void CreateCrafting()
        {
            ...
            CraftingTest.hohesLager.SetDescription("Der hohe Speicher verfügt über drei Tier-1- Befestigungsschlitze am Ende einer großen Stange, wobei 2 der Schlitze nach unten abgewinkelt sind und einer Straßenlaterne ähneln.");
