...
namespace AstroGuide.Scripts
{
    static class CraftingTest
    {
        ...
        public static Craft energiesensor = new Craft("Energiesensor", Resource.Drawable.Icon_Sensor, 500,CraftType.aktivierungsObjekt,3);
        public static Craft lagersensor = new Craft("Lagersensor", Resource.Drawable.Icon_Sensor, 750,CraftType.aktivierungsObjekt,3);
        public static Craft batteriesensor = new Craft("Batteriesensor", Resource.Drawable.Icon_Sensor, 750,CraftType.aktivierungsObjekt,3);
        public static Craft tastenwiederholer = new Craft("Tastenwiederholer", Resource.Drawable.Icon_Sensor, 300,CraftType.aktivierungsObjekt,4);
        public static Craft naeherungsinitiator = new Craft("Näherungsinitiator", Resource.Drawable.Icon_Sensor, 700,CraftType.aktivierungsObjekt,4);
        public static Craft verzoegerungswiederholer = new Craft("Verzögerungswiederholer", Resource.Drawable.Icon_Sensor, 1000,CraftType.aktivierungsObjekt,4);
        public static Craft zahlwiederholer = new Craft("Zahlwiederholer", Resource.Drawable.Icon_Sensor, 1000,CraftType.aktivierungsObjekt,4);
        ...
        public static Craft mSensorbogen = new Craft("Mittlerer Sensorbogen", Resource.Drawable.Icon_Sensor, 750,CraftType.aktivierungsObjekt,3);
        public static Craft xlSensorbogen = new Craft("XL-Sensorbogen", Resource.Drawable.Icon_Sensor, 1000,CraftType.aktivierungsObjekt,3);
        public static Craft xlSensorbaladachin = new Craft("XL-Sensorbaldachin", Resource.Drawable.Icon_Sensor, 1000,CraftType.aktivierungsObjekt,3);
        public static Craft gSensorring = new Craft("Großer Sensorring", Resource.Drawable.Icon_Sensor, 500,CraftType.aktivierungsObjekt,4);
        public static Craft gSensorringA = new Craft("Großer Sensorring A", Resource.Drawable.Icon_Sensor, 750,CraftType.aktivierungsObjekt,4);
        public static Craft gSensorringB = new Craft("Großer Sensorring B", Resource.Drawable.Icon_Sensor, 750,CraftType.aktivierungsObjekt,4);
        public static Craft xlSensorringA = new Craft("XL-Sensorring A", Resource.Drawable.Icon_Sensor, 750,CraftType.aktivierungsObjekt,4);
        public static Craft xlSensorringB = new Craft("XL-Sensorring B", Resource.Drawable.Icon_Sensor, 1000,CraftType.aktivierungsObjekt,4);
